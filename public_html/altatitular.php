...
<form class="form-input" action="altatitular2.php" method="post">

	<h2 class="mb-3 bd-text-purple-bright">Alta de Titular - Matricula <?=$matricula?></h2>
	...
	while ($data=mysqli_fetch_array($result)) {
		...
		echo "<option value='$id'>$nacionalidad</option>";
	}
	...
	<input type="number" id="nrodocumento" name="nrodocumento" class="form-control form-control-sm" required>
	</div>
	...
	<input type="text" id="nrocuit" name="nrocuit" class="form-control form-control-sm" required>
	</div>
	...
	<input type="text" id="fechanac" name="fechanac" class="form-control form-control-sm" placeholder="Ej: 2000-01-01" required>
	</div>
	...
	while ($data=mysqli_fetch_array($result)) {
		...
		echo "<option value='$id'>$nomcivil</option>";
	}
	mysqli_free_result($result);
	?>
	</select>
	...
	<input type="number" id="nupcias" name="nupcias" class="form-control form-control-sm">
	</div>

	<div class="form-group">
	<label for="conyuge">Conyuge</label>
	<input type="text" id="conyuge" name="conyuge" class="form-control form-control-sm">
	</div>

	</div>

	<div id="juridica2" style="display:none">

	<div class="form-group">
	<label for="tomorpc">Tomo R.P.C.</label>
	<input type="text" id="tomorpc" name="tomorpc" class="form-control form-control-sm">
	</div>

	<div class="form-group">
	<label for="foliorpc">Folio R.P.C.</label>
	<input type="text" id="foliorpc" name="foliorpc" class="form-control form-control-sm">
	</div>

	<div class="form-group">
	<label for="nrorpc">Nro R.P.C.</label>
	<input type="number" id="nrorpc" name="nrorpc" class="form-control form-control-sm">
	</div>

	<div class="form-group">
	<label for="fecharpc">Fecha R.P.C.</label>
	<input type="text" id="fecharpc" name="fecharpc" class="form-control form-control-sm" placeholder="Ej: 2000-01-01">
	</div>
	...
	<input type="text" id="porcentaje" name="porcentaje" class="form-control form-control-sm" placeholder="Ej: 12.34" required>
	</div>
